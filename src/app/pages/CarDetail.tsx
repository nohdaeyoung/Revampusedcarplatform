...
import { MessageCircle, Phone, CheckCircle2, ChevronRight, Share2, Heart, ShieldCheck, MapPin, Mail } from "lucide-react";
import { Link } from "react-router";

export function CarDetail() {
  const [activeImage, setActiveImage] = useState("https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=1200");
  const thumbnails = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[70%_auto] gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-200">
              <div className="aspect-[4/3] md:aspect-[16/9] rounded-2xl overflow-hidden mb-4 bg-gray-100 relative group">
              ...
              <div className="grid grid-cols-4 gap-2 md:gap-4">
                {thumbnails.map((img, idx) => (
                  <button 
                    ...
                    className={`aspect-[4/3] rounded-xl overflow-hidden border-2 transition-all ${activeImage === img ? 'border-blue-600 ring-2 ring-blue-600/20' : 'border-transparent hover:border-gray-300'}`}
                  >
          ...
          <div className="space-y-6">
            {/* Price Card */}
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-lg border border-gray-200 sticky top-28">
              <div className="mb-6">
