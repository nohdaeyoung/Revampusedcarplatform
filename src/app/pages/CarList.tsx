      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1 relative">
          ...
          <input 
            ...
            className={`w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-lg ${prefix ? 'pl-8' : 'pl-3'} pr-3 py-2 text-sm font-bold focus:outline-none focus:border-blue-500`} 
          />
        </div>
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          ...
          <select className="flex-1 md:w-auto bg-white border border-gray-300 text-gray-700 px-4 py-2.5 rounded-lg font-bold outline-none focus:border-blue-500">
        ...
        <aside className={`w-full lg:w-72 shrink-0 ${isMobileFilterOpen ? 'block' : 'hidden lg:block'}`}>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 sticky top-24">
            ...
            <div className="space-y-6">
              ...
              {/* Body Type */}
              <div>
                <h4 className="font-bold text-gray-900 mb-3 flex justify-between">Body Type <ChevronDown className="w-4 h-4" /></h4>
                <div className="space-y-2">
                  {['Sedan', 'SUV', 'Hatchback', 'Van/Minivan', 'Truck', 'Bus'].map(type => (
              ...
              {/* Steering */}
              <div>
                <h4 className="font-bold text-gray-900 mb-3 flex justify-between">Steering <ChevronDown className="w-4 h-4" /></h4>
                <div className="flex gap-2">
                  <button className="flex-1 py-2 border-2 border-blue-600 bg-blue-50 text-blue-700 rounded-lg font-bold">LHD</button>
                  <button className="flex-1 py-2 border border-gray-200 text-gray-600 hover:bg-gray-50 rounded-lg font-bold">RHD</button>
                </div>
              </div>
